...
// Main content
export const mainContent = `flex flex-col md:flex-col lg:flex-col xl:flex-row min-h-screen pt-12 xl:pt-35 md:items-center md:justify-center lg:items-center lg:justify-center xl:items-start xl:justify-start`;
...
export const loginButtonWrapper = `mt-16 flex justify-center md:mt-8 lg:mt-8 lg:justify-center xl:mt-10 xl:justify-start xl:ml-0`;

export const loginButton = `font-semibold bg-gradient-to-r from-[#0cc2ef] to-[#ecfa23] text-[#333333] rounded-[10px] w-[300px] h-[50px] text-lg md:rounded-[12px] md:w-full md:h-[45px] md:text-[17px] lg:rounded-[12px] lg:w-full lg:h-[45px] lg:text-[17px] xl:rounded-[15px] xl:w-[447px] xl:h-[47px] xl:text-lg`;

export const signupWrapper = `mt-8 text-center lg:text-center xl:w-[447px]`;

export const signupText = `text-white text-lg font-medium leading-none md:text-[17px] lg:text-[17px] xl:text-lg`;

export const signupButton = `text-white cursor-pointer hover:opacity-80 transition-opacity underline md:underline lg:underline xl:no-underline text-lg font-bold leading-none md:text-[17px] lg:text-[17px] xl:text-lg`;
