// ✅ CHANGED – FULL FILE
// Pagination + backend-based stats (NO page-based calculation)
            ...
            <Card key={s._id} className="bg-[#23272B] border-none">
              <CardContent className="p-4 space-y-2 text-sm">
                ...
                <p className="text-xs text-gray-500 border-t border-gray-700 pt-2">
                  Added by {getAdminName(s.createdBy)}
                </p>
              </CardContent>
            </Card>
          ))}
            ...
            <Card key={p._id} className="bg-[#23272B] border-none">
              <CardContent className="p-4 space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <p className="text-xs text-gray-400">
                    {new Date(p.campaignDate).toLocaleDateString()}
                  </p>
                </div>
                ...
                <p className="text-xs text-gray-500 border-t border-gray-700 pt-2">
                  Added by {getAdminName(p.createdBy)}
                </p>
              </CardContent>
            </Card>
          ))}
        ...
        <TabsContent value="summary">
          <Card className="bg-[#23272B] border-none">
            ...
            <CardContent className="text-sm space-y-2">
              ...
              <p>
                Shipping Collected: ₹
                {salesStats.totalShippingCollected}
              </p>
              <p>Marketing Spend: ₹{promoStats.totalPromotionSpend}</p>
              <p className="font-medium">
                Net: ₹
                {salesStats.totalSalesAmount -
                  promoStats.totalPromotionSpend}
              </p>
            </CardContent>
          </Card>
        </TabsContent>
